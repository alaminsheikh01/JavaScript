...
data.map((data) => {
  let row = `<tr>
            ...
            <td  class="col-2 col-xs-2 col-md-2"><button class="btn btn-primary m-3" onClick="onEdit(this); openModal(this);">Edit</button>
...
function insertNewRecord(data) {
  ...
  cell5.innerHTML = `<button class="btn btn-primary m-3" onClick="test(this)">Edit</button>
    <button class="btn btn-primary m-3" onClick="test1()">Delete</button>`;
}
